//// <copyright file="OkOrPreviewWindowViewModel.cs" company="BancLogix">
...
////   修改描述：新建 OkOrPreviewWindowViewModel
////   版本：1.0
//// </modify>
//// <review>
////   review人：
...
namespace DM2.Ent.Client.ViewModels.Common
{
    ...
    /// 确认or打印预览选择窗口
    /// </summary>
    public class OkOrPreviewWindowViewModel : BaseVm
    {
        #region 字段
        ...
        #region 构造函数
        /// <summary>
        /// Initializes a new instance of the <see cref="OkOrPreviewWindowViewModel"/> class.
        /// </summary>
        /// <param name="confirmInfo">要显示的文字</param>
        /// <param name="varOwnerId">拥有者Id</param>
        public OkOrPreviewWindowViewModel(string confirmInfo, string varOwnerId = null)
            : base(varOwnerId)
        {
        ...
        {
            this.result = ConfirmResults.Preview;
            this.TryClose(false);
        }
