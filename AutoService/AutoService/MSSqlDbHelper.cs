// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MSSqlDbHelper.cs" company="">
//   
// </copyright>
// <author>zoukp</author>
...
namespace AutoService
{
    ...
    public class MSSqlDbHelper
    {
        ...
        /// </returns>
        public DynamicObject DynamicProcWithParamsSingle<T>(string sql, dynamic parms, string connectionName = null)
        {
            using (SqlConnection connection = this.GetOpenConnection(connectionName))
            {
