//// <copyright file="NormalInfoWinViewModel.cs" company="BancLogix">
...
////   修改描述：新建 NormalInfoWinViewModel
////   版本：1.0
//// </modify>
//// <review>
////   review人：
...
namespace DM2.Ent.Client.ViewModels.Common
{
   ...
   /// 普通信息反馈窗口
   /// </summary>
    public class NormalInfoWinViewModel : BaseVm
    {
       /// <summary>
       /// 操作成功窗口
       /// </summary>
       ...
       /// <summary>
       /// Initializes a new instance of the <see cref="NormalInfoWinViewModel"/> class.
       /// </summary>
       /// <param name="confirmInfo">要显示的文字</param>
       /// <param name="propFlagStr">信息码</param>
       /// <param name="varOwnerId">拥有者Id</param>
        public NormalInfoWinViewModel(string confirmInfo, string propFlagStr, string varOwnerId = null)
            : base(varOwnerId)
        {
            this.DisplayName = RunTime.FindStringResource("Information");
            this.confirmInfo = confirmInfo;
            this.prompt = propFlagStr;
            Messenger.Default.Register<string>(this, "UpdateLanguage", msg => this.SetDisplayName(RunTime.FindStringResource("Information")));
        }
