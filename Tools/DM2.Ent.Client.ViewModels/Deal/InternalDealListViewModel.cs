// --------------------------------------------------------------------------------------------------------------------
// <copyright file="InternalDealListViewModel.cs" company="">
//   
// </copyright>
// <author>zoukp</author>
...
//      修改描述：新建 InternalDealListViewModel.cs
//      版本：1.0
// </modify>
// <review>
//      review人：
...
namespace DM2.Ent.Client.ViewModels
{
    ...
    /// </summary>
    public class InternalDealListViewModel : BaseVm
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InternalDealListViewModel"/> class.
        /// </summary>
        /// <param name="varOwnerId">
        /// 拥有者ID
        /// </param>
        public InternalDealListViewModel(string varOwnerId = null)
            : base(varOwnerId)
        {
        ...
        public void Search()
        {
            RunTime.GetCurrentRunTime().ActionOnUiThread(
                () =>
                {
                    ...
                    // 根据条件获取所有符合条件的Deal
                    List<FxInternalDealModel> tempDealList = this.dealReps.Filter(
                        o =>
                        {
                            // 判断DealID(模糊查询)
