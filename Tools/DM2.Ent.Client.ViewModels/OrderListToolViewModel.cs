...
namespace DM2.Ent.Client.ViewModels
{
    ...
    /// </summary>
    public class OrderListToolViewModel : BaseVm
    {
        #region Fields
        /*
        /// <summary>
        ...
        */
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderListToolViewModel"/> class.
        /// </summary>
        /// <param name="varOwnerId">
        /// The var owner id.
        /// </param>
        public OrderListToolViewModel(string varOwnerId = null)
            : base(varOwnerId)
        {
